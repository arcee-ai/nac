...
use nac_core::{
    ...
    model::{
        ...
        resolve_model_base_url, validate_caller_supplied_base_url, BackendKind,
        ManagedAuthProvider, ModelConfigurationError, ModelListing, ProviderModel, ReasoningEffort,
    },
