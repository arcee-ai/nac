...
# Exercise clean/smudge and a real LFS transfer as the managed user with the
# read-only root and mounted HOME; a binary-presence check misses setup failures.
